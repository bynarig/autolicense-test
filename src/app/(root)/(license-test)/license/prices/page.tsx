            ...
            <div className="flex justify-center-safe mt-40 h-150">
                <div className="card w-96 bg-base-100 shadow-sm">
                    <div className="card-body">
                        <span className="badge badge-xs badge-ghost">Standart</span>
                        ...
                        <div className="mt-6">
                            <button className="btn btn-primary btn-block btn-disabled">Subscribed</button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-sm">
                    <div className="card-body">
                        <span className="badge badge-xs badge-warning">Popular now</span>
                        <div className="flex justify-between">
